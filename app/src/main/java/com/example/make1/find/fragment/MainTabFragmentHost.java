 ...
 */
public class MainTabFragmentHost extends TabHost implements
	...
	public MainTabFragmentHost(Context context) {
	...
	public MainTabFragmentHost(Context context, AttributeSet attrs) {
		super(context, attrs);
